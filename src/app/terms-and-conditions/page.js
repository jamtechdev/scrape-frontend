    ...
    <div className="min-h-screen bg-gray-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="bg-white rounded-lg shadow-lg p-4 md:p-8 md:p-12 z-[1000] relative">
          <h1 className="text-2xl md:text-4xl font-extrabold text-[#26996f] mb-2">Terms and Conditions</h1>
          <p className="text-gray-500 mb-8 text-sm pl-2">Last Updated: January 2024</p>

          <div className="prose prose-lg max-w-none">
            {/* Section 1 */}
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl  font-bold text-[#000] mb-4 flex items-center gap-3">
                <FileText className="w-6 h-6 text-[#26996f]" /> 1. Acceptance of Terms
              </h2>
              <p className="text-sm md:text-base text-[#000] leading-relaxed mb-4">
                By accessing and using Adtrova ("the Service"), you accept and agree to be bound by the terms 
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl  font-bold text-[#000] mb-4 flex items-center gap-3">
                <Info className="w-6 h-6 text-[#26996f]" /> 2. Description of Service
              </h2>
              <p className="text-sm md:text-base text-[#000] leading-relaxed mb-4">
                Adtrova is a web-based application that provides access to publicly available Facebook and Instagram 
                ad data through Facebook's Ads Library API. Our Service allows you to:
              </p>
              <ul className="text-sm md:text-base list-disc pl-6 text-[#000] space-y-2 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl  font-bold text-[#000] mb-4 flex items-center gap-3">
                <UserCircle className="w-6 h-6 text-[#26996f]" /> 3. User Accounts
              </h2>
              
              <h3 className="text-xl font-bold text-[#000] mb-3 mt-6">3.1 Account Registration</h3>
              <p className="text-sm md:text-base text-[#000] leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-bold text-[#000] mb-3 mt-6">3.2 Account Responsibility</h3>
              <p className="text-sm md:text-base text-[#000] leading-relaxed mb-4">
                You are responsible for maintaining the confidentiality of your account credentials and for all activities 
                that occur under your account. You agree to:
              </p>
              <ul className="text-sm md:text-base list-disc pl-6 text-[#000] space-y-2">
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl  font-bold text-[#000] mb-4 flex items-center gap-3">
                <ShieldAlert className="w-6 h-6 text-[#26996f]" /> 4. Acceptable Use
              </h2>
              <p className="text-[#000] leading-relaxed mb-4">You agree to use the Service only for lawful purposes and in accordance with these Terms. You agree NOT to:</p>
              ...
              <p className="text-[#000] leading-relaxed bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-500">
                <strong className="text-[#000]">Important:</strong> Violation of these terms may result in immediate termination of your account 
                and legal action.
              </p>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl  font-bold text-[#000] mb-4 flex items-center gap-3">
                <Database className="w-6 h-6 text-[#26996f]" /> 5. Facebook Ads Library Data
              </h2>
              
              <h3 className="text-xl font-bold text-[#000] mb-3 mt-6">5.1 Data Source</h3>
              <p className="text-sm md:text-base text-[#000] leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-bold text-[#000] mb-3 mt-6">5.2 Data Usage</h3>
              <p className="text-[#000] leading-relaxed mb-2">You agree to use the ad data obtained through our Service:</p>
              <ul className="text-sm md:text-base list-disc pl-6 text-[#000] space-y-2 mb-4">
              ...
              <h3 className="text-xl font-bold text-[#000] mb-3 mt-6">5.3 Data Accuracy</h3>
              <p className="text-sm md:text-base text-[#000] leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl  font-bold text-[#000] mb-4 flex items-center gap-3">
                <Copyright className="w-6 h-6 text-[#26996f]" /> 6. Intellectual Property
              </h2>
              
              <h3 className="text-xl font-bold text-[#000] mb-3 mt-6">6.1 Our Intellectual Property</h3>
              <p className="text-sm md:text-base text-[#000] leading-relaxed mb-4">
                The Service and its original content, features, and functionality are owned by Adtrova and are 
                protected by international copyright, trademark, patent, trade secret, and other intellectual property laws.
              </p>

              <h3 className="text-xl font-bold text-[#000] mb-3 mt-6">6.2 User Content</h3>
              <p className="text-sm md:text-base text-[#000] leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-bold text-[#000] mb-3 mt-6">6.3 Third-Party Content</h3>
              <p className="text-sm md:text-base text-[#000] leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl  font-bold text-[#000] mb-4 flex items-center gap-3">
                <CreditCard className="w-6 h-6 text-[#26996f]" /> 7. Payment and Billing
              </h2>
              
              <h3 className="text-xl font-bold text-[#000] mb-3 mt-6">7.1 Subscription Plans</h3>
              <p className="text-sm md:text-base text-[#000] leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-bold text-[#000] mb-3 mt-6">7.2 Payment Terms</h3>
              <ul className="text-sm md:text-base list-disc pl-6 text-[#000] space-y-2 mb-4">
              ...
              <h3 className="text-xl font-bold text-[#000] mb-3 mt-6">7.3 Cancellation</h3>
              <p className="text-sm md:text-base text-[#000] leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl  font-bold text-[#000] mb-4 flex items-center gap-3">
                <Activity className="w-6 h-6 text-[#26996f]" /> 8. Service Availability
              </h2>
              <p className="text-sm md:text-base text-[#000] leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl  font-bold text-[#000] mb-4 flex items-center gap-3">
                <Scale className="w-6 h-6 text-[#26996f]" /> 9. Limitation of Liability
              </h2>
              <p className="text-sm md:text-base text-[#000] leading-relaxed mb-4">
                TO THE MAXIMUM EXTENT PERMITTED BY LAW, Adtrova SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, 
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl  font-bold text-[#000] mb-4 flex items-center gap-3">
                <ShieldCheck className="w-6 h-6 text-[#26996f]" /> 10. Indemnification
              </h2>
              <p className="text-sm md:text-base text-[#000] leading-relaxed">
                You agree to indemnify, defend, and hold harmless Adtrova, its officers, directors, employees, 
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl  font-bold text-[#000] mb-4 flex items-center gap-3">
                <LogOut className="w-6 h-6 text-[#26996f]" /> 11. Termination
              </h2>
              
              <h3 className="text-xl font-bold text-[#000] mb-3 mt-6">11.1 Termination by You</h3>
              <p className="text-sm md:text-base text-[#000] leading-relaxed mb-4">
                You may terminate your account at any time by contacting us or using the account deletion feature in your 
                account settings.
              </p>

              <h3 className="text-xl font-bold text-[#000] mb-3 mt-6">11.2 Termination by Us</h3>
              <p className="text-sm md:text-base text-[#000] leading-relaxed mb-2">We may terminate or suspend your account immediately, without prior notice, if:</p>
              <ul className="text-sm md:text-base list-disc pl-6 text-[#000] space-y-2 mb-4">
              ...
              <h3 className="text-xl font-bold text-[#000] mb-3 mt-6">11.3 Effect of Termination</h3>
              <p className="text-sm md:text-base text-[#000] leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl  font-bold text-[#000] mb-4 flex items-center gap-3">
                <AlertTriangle className="w-6 h-6 text-[#26996f]" /> 12. Disclaimers
              </h2>
              <p className="text-sm md:text-base text-[#000] leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl  font-bold text-[#000] mb-4 flex items-center gap-3">
                <RefreshCw className="w-6 h-6 text-[#26996f]" /> 13. Changes to Terms
              </h2>
              <p className="text-sm md:text-base text-[#000] leading-relaxed mb-2">We reserve the right to modify these Terms at any time. We will notify you of any changes by:</p>
              <ul className="text-sm md:text-base list-disc pl-6 text-[#000] space-y-2 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl  font-bold text-[#000] mb-4 flex items-center gap-3">
                <Gavel className="w-6 h-6 text-[#26996f]" /> 14. Governing Law
              </h2>
              <p className="text-sm md:text-base text-[#000] leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl  font-bold text-[#000] mb-4 flex items-center gap-3">
                <Layers className="w-6 h-6 text-[#26996f]" /> 15. Severability
              </h2>
              <p className="text-sm md:text-base text-[#000] leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl md:text-2xl  font-bold text-[#000] mb-4 flex items-center gap-3">
                <Mail className="w-6 h-6 text-[#26996f]" /> 16. Contact Information
              </h2>
              <p className="text-[#000] leading-relaxed mb-4">
                If you have any questions about these Terms and Conditions, please contact us:
              </p>
              <div className="bg-gray-50 p-6 rounded-lg border-l-4 border-[#26996f]">
                <p className="text-[#000] mb-2"><strong>Email:</strong> support@yourdomain.com</p>
                <p className="text-[#000] mb-2"><strong>Address:</strong> [Your Company Address]</p>
                <p className="text-[#000]"><strong>Phone:</strong> [Your Contact Number]</p>
              </div>
            </section>

            {/* Footer */}
            <div className="mt-12 pt-8 border-t border-gray-200">
              <p className="text-sm md:text-base text-gray-600 text-sm">
                These Terms and Conditions are effective as of the "Last Updated" date and apply to all users of our Service.
              </p>
              <div className="mt-4 flex gap-4">
                <Link 
                  href="/privacy-policy" 
                  className="text-[#000] font-bold hover:underline text-sm"
                >
                  View Privacy Policy
                </Link>
                <Link 
